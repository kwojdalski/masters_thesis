...
```{=latex}
\addcontentsline{lap}{section}{Feature Inventory}
```
...
```{=latex}
\addcontentsline{lap}{section}{Main Experiment Specification}
```
...
```{=latex}
\addcontentsline{lap}{section}{Baseline Algorithm Pseudocode}
```
...
```{=latex}
\addcontentsline{lap}{section}{Raw Data Inventory}
```
...
```{=latex}
\addcontentsline{lap}{section}{Transformed Feature Example}
```
...
```{=latex}
\addcontentsline{lap}{section}{Feature Distribution Statistics}
```
...
```{=latex}
\addcontentsline{lap}{section}{Feature-Return Correlations}
```
...
```{=latex}
\addcontentsline{lap}{section}{Data Preparation Pipeline}
```
...
```{=latex}
\addcontentsline{lap}{section}{Offline Feature Selection Pipeline}
```
...
```{=latex}
\addcontentsline{lap}{section}{Experimental Pipeline Architecture}
```
