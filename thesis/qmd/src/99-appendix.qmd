...
{\footnotesize\parindent0pt\raggedright\relax Source: author's own compilation; each formula is attributed to its originating study in the Citation column.\par}
\end{landscape}
```
