...
Section 5.4 gives TD3's full training loop (Algorithm 2) since TD3 is this
...
\begin{algorithm}
\caption{DDPG Training (follows Algorithm 1)}
\begin{algorithmic}
\REQUIRE Processed environments from Algorithm 1; DDPG hyperparameters
...
\begin{algorithm}
\caption{PPO Training (follows Algorithm 1)}
\begin{algorithmic}
\REQUIRE Processed environments from Algorithm 1; PPO hyperparameters
...
**For DDPG** (beyond the symbols already defined in Section 5.4 for TD3):
