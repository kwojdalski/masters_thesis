...
```{=latex}
\addcontentsline{loa}{section}{Feature Inventory}
```
...
```{=latex}
\addcontentsline{loa}{section}{Main Experiment Specification}
```
...
```{=latex}
\addcontentsline{loa}{section}{Baseline Algorithm Pseudocode}
```
...
```{=latex}
\addcontentsline{loa}{section}{Raw Data Inventory}
```
...
```{=latex}
\addcontentsline{loa}{section}{Transformed Feature Example}
```
...
```{=latex}
\addcontentsline{loa}{section}{Feature Distribution Statistics}
```
...
```{=latex}
\addcontentsline{loa}{section}{Feature-Return Correlations}
```
...
```{=latex}
\addcontentsline{loa}{section}{Data Preparation Pipeline}
```
...
```{=latex}
\addcontentsline{loa}{section}{Offline Feature Selection Pipeline}
```
...
```{=latex}
\addcontentsline{loa}{section}{Experimental Pipeline Architecture}
```
