...
{\footnotesize\itshape\parindent0pt\raggedright\relax\textbf{Source:} author's own compilation.\par}
{\footnotesize\itshape\parindent0pt\raggedright\relax\textbf{Note:} formulas are implementations or adaptations; citations identify conceptual sources where applicable. A dash denotes an author's construction or no direct originating formula.\par}
\end{landscape}
```
