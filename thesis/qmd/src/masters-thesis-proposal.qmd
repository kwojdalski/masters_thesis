...
- 1.2 Scope and Objectives of the Research
  - 1.2.1 Hypotheses
    ...
    - These algorithms demonstrate the capability to implicitly learn market
      ...
      select securities. In consequence, they generate alpha or at least
      desirable investment performance characteristics
...
states are infeasible). The factor $3$ represents the three possible cell
