...
high-frequency trading with order-book-derived market data. The investigation
covers both the theoretical foundations and practical constraints of applying
reinforcement learning in market microstructure settings, including benchmark
evaluation and execution-related assumptions.
...
The empirical component implements a TD3-based reinforcement learning approach
for continuous exposure control on high-frequency AAPL order-book data, and
evaluates performance relative to multiple benchmarks under explicitly stated
