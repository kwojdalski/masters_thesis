...
$$\mathcal{A} = [-1.0, 1.0]$$ {#eq-action-space}
...
$$\text{fee}_t = c \times |a_t - a_{t-1}| \times \text{notional value}$$ {#eq-transaction-fee}
...
$$a_t^{\text{noisy}} = \text{clip}(a_t + \epsilon, -1.0, 1.0)$$ {#eq-exploration-noise}
