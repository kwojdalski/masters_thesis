...
The primary research goal is to evaluate the Reinforcement Learning-based algorithm for multiasset trading. The main idea behind the algorithm deployment is
that it can systematically outperform benchmarks in terms of both risk and return. By learning, it will be able to spot patterns faster than human what contributes to better
