...
<<r, include=FALSE, cache=FALSE,echo=FALSE,eval=TRUE>>=
...
<<fx_market_organization, child='chapters/subchapters/1_2_FX_Market_Organization.Rmd'>>=
...
<<modern_portfolio_theory_and_capm,child='chapters/subchapters/2_1_1_Modern_Portfolio_Theory_and_CAPM.Rmd'>>=

@

<<relevant_financial_indicators2,child='chapters/subchapters/2_2_Relevant_Financial_Indicators.Rmd'>>=
@
