...
```{rr, include=FALSE, cache=FALSE,echo=FALSE,eval=TRUE}
...
```{rfx_market_organization, child='chapters/subchapters/1_2_FX_Market_Organization.Rmd'}
...
```{rmodern_portfolio_theory_and_capm,child='chapters/subchapters/2_1_1_Modern_Portfolio_Theory_and_CAPM.Rmd'}

```

```{rrelevant_financial_indicators2,child='chapters/subchapters/2_2_Relevant_Financial_Indicators.Rmd'}
```
