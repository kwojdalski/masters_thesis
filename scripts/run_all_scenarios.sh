...
for scenario in default sine_wave sine_wave_ppo_no_trend sine_wave_ppo_trend mean_reversion upward_trend_ddpg upward_trend_ppo white_noise_no_trend_ppo; do
