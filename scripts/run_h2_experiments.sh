...
#   EXTRA_TRAIN_ARGS="logging.debug_plots=true" EXTRA_EVAL_ARGS="logging.debug_plots=true" bash scripts/run_h2_experiments.sh
#
...
if [[ $SKIP_EVAL -eq 1 ]]; then
    echo "=== H2: Skipping evaluate (--skip-eval) ==="
else
echo "=== H2: Evaluating ==="
if [[ $PARALLEL -eq 1 ]]; then
