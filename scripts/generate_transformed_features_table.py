...
def generate_transformed_features_table():
    ...
    table_df["Order Imbalance"] = sample_df[
        "feature_hft_order_book_imbalance_3l"
    ].round(2)
    ...
    markdown_table.append(
        "| Time (UTC) | Best Bid ($) | Best Ask ($) | Bid Size | Ask Size | Book Pressure | Order Imbalance | Microprice Deviation | Order Flow Imbalance |"
    )
    markdown_table.append(
        "|------------|--------------|--------------|----------|----------|----------------|-----------------|----------------------|----------------------|"
    )
...
def main():
    ...
    print("\n" + "=" * 120)
    print(
        "CAPTION: Sample of raw order book data and corresponding transformed microstructure features."
    )
    print(
        "The transformed features are normalized and capture the relevant signals for the RL agent."
    )
    print("=" * 120)
